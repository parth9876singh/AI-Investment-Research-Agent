...
/**
 * Controller to conduct full research graph synchronously and return cached/new results.
 * 
 * @param {object} req - Express request object.
 * @param {object} res - Express response object.
 */
export async function conductResearch(req, res) {
  try {
...
/**
 * Controller to stream research graph progress via Server-Sent Events (SSE).
 * 
 * @param {object} req - Express request object.
 * @param {object} res - Express response object.
 */
