  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-4">
      <form
        ...
        className="relative flex items-center p-1.5 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-md shadow-2xl focus-within:border-indigo-500/50 focus-within:shadow-[0_0_30px_-5px_rgba(99,102,241,0.2)] transition-all duration-300 ease-out group"
      >
        {/* Search Icon */}
